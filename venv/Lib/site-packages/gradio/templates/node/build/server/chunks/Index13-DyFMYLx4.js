...
import { B as Block, S as StatusTracker, e as BlockLabel, O as Code$2, g as Empty, i as IconButton$1, H as Copy$1, D as Download$1, h as IconButtonWrapper$1 } from './2-CM3gFCtA.js';
...
const lang_map = {
  python: () => import('./index27-BlSwenVc.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-TjV2pYOb.js'),
      import('./frontmatter-hzXytYGa.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-B26a1bRI.js').then((m) => m.json()),
  html: () => import('./index29-BtQXIpNj.js').then((m) => m.html()),
  css: () => import('./index30-BYq2Cds3.js').then((m) => m.css()),
  javascript: () => import('./index31-qvhcjx2e.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-qvhcjx2e.js').then(
...
//# sourceMappingURL=Index13-DyFMYLx4.js.map
